    ...
    function html5Upload() {	
    	...
    	sUploadURL= '../../../boardFile/php_uploader/php/file_uploader_html5.jsp'; 	//upload URL
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){
    	var oAjax = jindo.$Ajax(sUploadURL, {
			...
			onload : function(res){ // 요청이 완료되면 실행될 콜백 함수
				var sResString = res._response.responseText;console.log(sResString);
				if (res.readyState() == 4) {
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '../../../boardFile/php_uploader/php/file_uploader.php',	//C:/fp_root/php_uploader/upload
